...
ggplot(station_ave, aes(x=wind.sp_50, y=temp_50)) +
  ...
  geom_smooth(method = "gam", col=2) #test
...
Linear model has an r-square 0.01, which is bad. Not fitting the data very well.
However, for the gam model, we have a good r-square. However, we may faced an overfitting model (base on k = 20).
...
https://github.com/ZhouEEEEEE/JSC370-labs.git
